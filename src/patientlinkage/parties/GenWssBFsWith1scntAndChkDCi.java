 ...
 * @param <T>
 */
public class GenWssBFsWith1scntAndChkDCi <T> extends network.Server{
    ...
    public GenWssBFsWith1scntAndChkDCi(int port, Mode mode, int numOfTasks, boolean[][][] bin_a, boolean[][][] BFs1sCnt_a, boolean[][] Ws_a, boolean[] threshold_a, int len_b, ArrayList<String> PartyA_IDs) {
        this.port = port;
        this.mode = mode;
        this.bin_a = bin_a;
 ...
 public GenWssBFsWith1scntAndChkDCi(int port, Mode mode, int numOfTasks, boolean[][][] bin_a, boolean[][][] BFs1sCnt_a, boolean[][] Ws_a, boolean[] threshold_a,boolean[][] chkDCi, int len_b, ArrayList<String> PartyA_IDs) {
        this.port = port;
        this.mode = mode;
        this.bin_a = bin_a;
        this.BFs1sCnt_a = BFs1sCnt_a;
    ...
    public void implement() {
        ...
        try {
            ...
            for (int i = 0; i < this.numOfTasks; i++) {
                PatientLinkage4GadgetWsBF1sCntInputs<T> tmp0 = new PatientLinkage4GadgetWsBF1sCntInputs<>(Arrays.copyOfRange(bin_a, Range0[i][0], Range0[i][1]), 
                                                                    Arrays.copyOfRange(BFs1sCnt_a, Range0[i][0], Range0[i][1]) , Ws_a, threshold_a, 
                                                                    Arrays.copyOfRange(chkDCi, Range0[i][0], Range0[i][1]) ,gen, "Alice", i);
                PatientLinkage4GadgetWsBF1sCntInputs<T> tmp1 = new PatientLinkage4GadgetWsBF1sCntInputs<>(bin_b,BFs1sCnt_b, Ws_b, threshold_b,
