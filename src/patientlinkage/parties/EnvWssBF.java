 ...
 * @param <T>
 */
public class EnvWssBF <T> extends network.Client{
    String addr;
    int port;
    Mode mode;
    boolean[][][] bin_b;
    ...
    public EnvWssBF(String addr, int port, Mode mode, int numOfTasks, boolean[][][] bin_b, boolean[][] Ws_b, boolean[] threshold_b, int len_a, ArrayList<String> PartyB_IDs) {
        this.addr = addr;
        this.port = port;
        this.mode = mode;
        this.bin_b = bin_b;
