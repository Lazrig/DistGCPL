 ...
 * @author cf
 */
public class BatchDataHelper  implements java.io.Serializable{
    public ArrayList<String> IDs = new ArrayList<>(); // array of record IDs of this BlockID
    public int BlockingVar;
    public ArrayList<Integer> BlockIDs= new ArrayList<>();
...
public BatchDataHelper(int BlkVar, boolean RmvMatch){
