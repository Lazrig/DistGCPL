 ...
 * @param <T>
 */
public class PatientLinkage4GadgetWsBF1sCntCLRExchInputs<T> extends PatientLinkage4GadgetWsInputs<T> {

    
    private T[][][] BFs1sCnt;
    boolean[][] RecsToChkDC;  // records to compute their DCi. After filtering of each part of The BF

    public PatientLinkage4GadgetWsBF1sCntCLRExchInputs(boolean[][][] Inputs,boolean[][][] BFs1sCnt, boolean[][] weights, boolean[] threshold, CompEnv<T> gen, String role, int th_ID) {
   ...
   //----------------------New const. with added chkDCi
    public PatientLinkage4GadgetWsBF1sCntCLRExchInputs(boolean[][][] Inputs,boolean[][][] BFs1sCnt, boolean[][] weights, boolean[] threshold,boolean[][] chkDCi, CompEnv<T> gen, String role, int th_ID) {
        super(Inputs,weights, threshold, gen, role, th_ID);
