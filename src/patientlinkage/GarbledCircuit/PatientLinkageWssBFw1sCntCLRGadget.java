 ...
 * @param <T>
 */
public class PatientLinkageWssBFw1sCntCLRGadget<T> extends Gadget<T> {
    ...
    public Object secureCompute(CompEnv<T> e, Object[] o) throws Exception {
        T[][][] a = (T[][][]) ((PatientLinkage4GadgetInputsAndClr1sChkDci) o[0]).getInputs();
        T[][][] b = (T[][][]) ((PatientLinkage4GadgetInputsAndClr1sChkDci) o[1]).getInputs();
        
       // T[][][] a1s = (T[][][]) ((PatientLinkage4GadgetWsBF1sCntInputs) o[0]).getBFs1sCnt();
        //T[][][] b1s = (T[][][]) ((PatientLinkage4GadgetWsBF1sCntInputs) o[1]).getBFs1sCnt();
        
        boolean[][] aChkDci = (boolean[][]) ((PatientLinkage4GadgetInputsAndClr1sChkDci) o[0]).getBFs1schkDCi();
        boolean[][] bChkDci = (boolean[][]) ((PatientLinkage4GadgetInputsAndClr1sChkDci) o[1]).getBFs1schkDCi();
       ...
       // T[] Rhs ,/*=e.newTArray(dl),*/ Lhs;//=e.newTArray(dl);
        ...
        return new PatientLinkageWssBFOutput<>(ret_a, ret_b);
    }
